		...
		<view class="register-form">
			...
			<view class="form-content">
				<view class="form-item form-account">
					...
					<input type="text" value="" placeholder="请输入姓名" v-model.trim="queryForm.nickname" />
				</view>
				<view class="form-item form-account">
					<image class="item-icon" src="../../static/img/login/password.png"></image>
				...
				<view class="form-item form-password-confirm">
					<image class="item-icon" src="../../static/img/login/password.png"></image>
					<input type="password" value="" placeholder="请输入确认密码" v-model.trim="queryForm.confirmPasswd" />
				</view>
				...
				<view class="form-item form-invite">
					<image class="item-icon" src="../../static/img/login/password.png"></image>
					<input type="text" value="" placeholder="请输入邀请人id" v-model.trim="queryForm.inviteCode" />
				</view>
